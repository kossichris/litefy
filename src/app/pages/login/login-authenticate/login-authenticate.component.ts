...
export class LoginAuthenticateComponent {
    ...
    login() {
        ...
        const scope =
            "user-top-read user-read-currently-playing user-read-playback-state user-read-recently-played user-modify-playback-state streaming user-read-private user-read-email user-library-read playlist-modify-public";
